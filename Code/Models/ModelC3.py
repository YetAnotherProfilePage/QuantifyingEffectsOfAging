...
def modelC3(y,t,p,k_V,c_V,s_T,r,c_T,K):
    V,T = y
    
    dVdt = p*V*(1-V/k_V)*(1/(1+(K*T)**2))-c_V*V*T
    dTdt = s_T + r*T*V - c_T*T
...
def ModelC3_RMSLE(x,times,step_res,Viral_Data,CD8_Data,
    ...
    p,k_V,c_V,r,c_T,K,T_0,V_0 = x #This is the order the parameters should be input.
    ...
    predictions = sp.integrate.odeint(modelC3,
                                         y0,
                                         t,
                                         args=(p,k_V,c_V,s_T,r,c_T,K)
...
def ModelC3_AICc(x,times,step_res,Viral_Data,CD8_Data,
                 Viral_Data_Col='Viral Titer (Pfu/ml)',
...
def ModelC3_Predict(x,times,step_res):
    p,k_V,c_V,r,c_T,K,T_0,V_0 = x
    s_T = c_T* T_0
    y0 = [V_0,T_0]
...
def ModelC3_ViralClearanceTime(x,times,step_res,threshhold = 10.0):
    p,k_V,c_V,r,c_T,K,T_0,V_0 = x
    s_T = c_T* T_0
    y0 = [V_0,T_0]
...
def ModelC3_TotalViralLoad(x,times,step_res,threshhold = 10.0):
    p,k_V,c_V,r,c_T,K,T_0,V_0 = x
    s_T = c_T* T_0
    y0 = [V_0,T_0]
...
def ModelC3_ExcessCTL(x,times,step_res,threshhold = 10.0):
    p,k_V,c_V,r,c_T,K,T_0,V_0 = x
    s_T = c_T* T_0
    y0 = [V_0,T_0]
