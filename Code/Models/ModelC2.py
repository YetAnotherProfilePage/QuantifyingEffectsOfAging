...
def modelC2(y,t,p,k_V,c_V,s_T,r,k_T,c_T,d_T,K):
    V,T = y
...
def ModelC2_RMSLE(x,times,step_res,Viral_Data,CD8_Data,
    ...
    p,k_V,c_V,r,k_T,c_T,d_T,K,T_0,V_0 = x #This is the order the parameters should be input.
    ...
    predictions = sp.integrate.odeint(modelC2,
                                         y0,
                                         t,
                                         args=(p,k_V,c_V,s_T,r,k_T,c_T,d_T,K)
...
def ModelC2_Predict(x,times,step_res):
    p,k_V,c_V,r,k_T,c_T,d_T,K,T_0,V_0 = x
    s_T = (d_T + c_T)*T_0
    y0 = [V_0,T_0]
