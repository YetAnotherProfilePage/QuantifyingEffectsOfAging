...
def modelC4(y,t,p,k_V,c_V,s_T,r,c_T,d_T,K):
    V,T = y
...
def ModelC4_RMSLE(x,times,step_res,Viral_Data,CD8_Data,
    ...
    p,k_V,c_V,r,c_T,d_T,K,T_0,V_0 = x #This is the order the parameters should be input.
    ...
    predictions = sp.integrate.odeint(modelC4,
                                         y0,
                                         t,
                                         args=(p,k_V,c_V,s_T,r,c_T,d_T,K)
...
def ModelC4_Predict(x,times,step_res):
    p,k_V,c_V,r,c_T,d_T,K,T_0,V_0 = x
    s_T = (c_T +d_T) * T_0
    y0 = [V_0,T_0]
