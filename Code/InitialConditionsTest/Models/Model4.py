...
def model4(y,t,p,k_V,c_V,s_T,r,c_T,d_T):
    V,T = y
...
def Model4_RMSLE(x,times,step_res,Viral_Data,CD8_Data,
    ...
    predictions = sp.integrate.odeint(model4,
                                         y0,
                                         t,
...
def Model4_AICc(x,times,step_res,Viral_Data,CD8_Data,
                 Viral_Data_Col='Viral Titer (Pfu/ml)',
...
def Model4_Predict(x,times,step_res):
