...
def modelA2(y,t,p,k_V,c_V,s_T,r,k_T,c_T,d_T):
    V,T = y
...
def ModelA2_RMSLE(x,times,step_res,Viral_Data,CD8_Data,
    ...
    predictions = sp.integrate.odeint(modelA2,
                                         y0,
                                         t,
...
def ModelA2_AICc(x,times,step_res,Viral_Data,CD8_Data,
                 Viral_Data_Col='Viral Titer (Pfu/ml)',
...
def ModelA2_Predict(x,times,step_res):
...
def ModelA2_ViralClearanceTime(x,times,step_res,threshhold = 10.0):
...
def ModelA2_TotalViralLoad(x,times,step_res,threshhold = 10.0):
...
def ModelA2_ExcessCTL(x,times,step_res,threshhold = 10.0):
