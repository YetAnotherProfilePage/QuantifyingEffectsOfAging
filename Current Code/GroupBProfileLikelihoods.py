...
ModelB1_Fitted_Params_Indices = [0,1,3,5,6]
...
if __name__ == "__main__":
    ...
    #Create_Likelihood_Profile(ModelB1_RMSLE,SAMPLES,Adult_ModelB1_Parameter_Bounds,ModelB1_Fitted_Params_Indices,ModelB1_Params_Labels,Adult_Viral_Data,Adult_CD8_Data,"ModelB1_Adult",'log',repeats=REPEATS)
    Create_Likelihood_Profile(ModelB1_RMSLE,SAMPLES,Aged_ModelB1_Parameter_Bounds,ModelB1_Fitted_Params_Indices,ModelB1_Params_Labels,Aged_Viral_Data,Aged_CD8_Data,"ModelB1_Aged",'log',repeats=REPEATS)
    
    #Create_Likelihood_Profile(ModelB2_RMSLE,SAMPLES,Adult_ModelB2_Parameter_Bounds,ModelB2_Fitted_Params_Indices,ModelB2_Params_Labels,Adult_Viral_Data,Adult_CD8_Data,"ModelB2_Adult",'log',repeats=REPEATS)
    #Create_Likelihood_Profile(ModelB2_RMSLE,SAMPLES,Aged_ModelB2_Parameter_Bounds,ModelB2_Fitted_Params_Indices,ModelB2_Params_Labels,Aged_Viral_Data,Aged_CD8_Data,"ModelB2_Aged",'log',repeats=REPEATS)

    #Create_Likelihood_Profile(ModelB3_RMSLE,SAMPLES,Adult_ModelB3_Parameter_Bounds,ModelB3_Fitted_Params_Indices,ModelB3_Params_Labels,Adult_Viral_Data,Adult_CD8_Data,"ModelB3_Adult",'log',repeats=REPEATS)
    #Create_Likelihood_Profile(ModelB3_RMSLE,SAMPLES,Aged_ModelB3_Parameter_Bounds,ModelB3_Fitted_Params_Indices,ModelB3_Params_Labels,Aged_Viral_Data,Aged_CD8_Data,"ModelB3_Aged",'log',repeats=REPEATS)
    
    #Create_Likelihood_Profile(ModelB4_RMSLE,SAMPLES,Adult_ModelB4_Parameter_Bounds,ModelB4_Fitted_Params_Indices,ModelB4_Params_Labels,Adult_Viral_Data,Adult_CD8_Data,"ModelB1_Adult",'log',repeats=REPEATS)
    #Create_Likelihood_Profile(ModelB4_RMSLE,SAMPLES,Aged_ModelB4_Parameter_Bounds,ModelB4_Fitted_Params_Indices,ModelB4_Params_Labels,Aged_Viral_Data,Aged_CD8_Data,"ModelB1_Aged",'log',repeats=REPEATS)
