...
CD8_Data = pd.read_csv("ExperimentalData_SharedInitialT/ReorganizedData_CD8.csv")
Viral_Data = pd.read_csv("ExperimentalData_SharedInitialT/ReorganizedData_ViralTiter.csv")
