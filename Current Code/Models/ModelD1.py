...
def modelD1(y,t,beta,d_I,p,c,s_T,d_T,r):
    U,I,V,T = y
...
def ModelD1_RMSLE(x,times,step_res,Viral_Data,CD8_Data,
    ...
    beta,d_I,p,c,d_T,r,U_0,I_0,V_0,T_0 = x #This is the order the parameters should be input.
