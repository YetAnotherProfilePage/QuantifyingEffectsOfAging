...
def modelC4(y,t,p,k_V,c_V,s_T,r,c_T,d_T):
    V,T = y
...
def ModelC4_RMSLE(x,times,step_res,Viral_Data,CD8_Data,
    ...
    predictions = sp.integrate.odeint(modelC4,
                                         y0,
                                         t,
...
def ModelC4_AICc(x,times,step_res,Viral_Data,CD8_Data,
                 Viral_Data_Col='Viral Titer (Pfu/ml)',
...
def ModelC4_Predict(x,times,step_res):
...
def ModelC4_ViralClearanceTime(x,times,step_res,threshhold = 10.0):
    p,k_V,c_V,r,c_T,d_T,T_0,V_0 = x
    s_T = (c_T +d_T) * T_0
    y0 = [V_0,T_0]
...
def ModelC4_TotalViralLoad(x,times,step_res,threshhold = 10.0):
    p,k_V,c_V,r,c_T,d_T,T_0,V_0 = x
    s_T = (c_T +d_T) * T_0
    y0 = [V_0,T_0]
...
def ModelC4_ExcessCTL(x,times,step_res,threshhold = 10.0):
    p,k_V,c_V,r,c_T,d_T,T_0,V_0 = x
    s_T = (c_T +d_T) * T_0
    y0 = [V_0,T_0]
