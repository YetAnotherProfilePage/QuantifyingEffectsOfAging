...
if __name__ == "__main__":
    ## GROUP A AICC
    adult_modelA1_AICc = ModelA1_AICc(adult_modelA1_params,19,1000,Adult_Viral_Data,Adult_CD8_Data)
    aged_modelA1_AICc = ModelA1_AICc(aged_modelA1_params,19,1000,Aged_Viral_Data,Aged_CD8_Data)

    adult_modelA2_AICc = ModelA2_AICc(adult_modelA2_params,19,1000,Adult_Viral_Data,Adult_CD8_Data)
    aged_modelA2_AICc = ModelA2_AICc(aged_modelA2_params,19,1000,Aged_Viral_Data,Aged_CD8_Data)

    adult_modelA3_AICc = ModelA3_AICc(adult_modelA3_params,19,1000,Adult_Viral_Data,Adult_CD8_Data)
    aged_modelA3_AICc = ModelA3_AICc(aged_modelA3_params,19,1000,Aged_Viral_Data,Aged_CD8_Data)
    
    adult_modelA4_AICc = ModelA4_AICc(adult_modelA4_params,19,1000,Adult_Viral_Data,Adult_CD8_Data)
    aged_modelA4_AICc = ModelA4_AICc(aged_modelA4_params,19,1000,Aged_Viral_Data,Aged_CD8_Data)

    ## GROUP B AICC
    adult_modelB1_AICc = ModelB1_AICc(adult_modelB1_params,19,1000,Adult_Viral_Data,Adult_CD8_Data)
    aged_modelB1_AICc = ModelB1_AICc(aged_modelB1_params,19,1000,Aged_Viral_Data,Aged_CD8_Data)

    adult_modelB2_AICc = ModelB2_AICc(adult_modelB2_params,19,1000,Adult_Viral_Data,Adult_CD8_Data)
    aged_modelB2_AICc = ModelB2_AICc(aged_modelB2_params,19,1000,Aged_Viral_Data,Aged_CD8_Data)

    adult_modelB3_AICc = ModelB3_AICc(adult_modelB3_params,19,1000,Adult_Viral_Data,Adult_CD8_Data)
    aged_modelB3_AICc = ModelB3_AICc(aged_modelB3_params,19,1000,Aged_Viral_Data,Aged_CD8_Data)
    
    adult_modelB4_AICc = ModelB4_AICc(adult_modelB4_params,19,1000,Adult_Viral_Data,Adult_CD8_Data)
    aged_modelB4_AICc = ModelB4_AICc(aged_modelB4_params,19,1000,Aged_Viral_Data,Aged_CD8_Data)

    ## GROUP C AICC
    adult_modelC1_AICc = ModelC1_AICc(adult_modelC1_params,19,1000,Adult_Viral_Data,Adult_CD8_Data)
    aged_modelC1_AICc = ModelC1_AICc(aged_modelC1_params,19,1000,Aged_Viral_Data,Aged_CD8_Data)

    adult_modelC2_AICc = ModelC2_AICc(adult_modelC2_params,19,1000,Adult_Viral_Data,Adult_CD8_Data)
    aged_modelC2_AICc = ModelC2_AICc(aged_modelC2_params,19,1000,Aged_Viral_Data,Aged_CD8_Data)

    adult_modelC3_AICc = ModelC3_AICc(adult_modelC3_params,19,1000,Adult_Viral_Data,Adult_CD8_Data)
    aged_modelC3_AICc = ModelC3_AICc(aged_modelC3_params,19,1000,Aged_Viral_Data,Aged_CD8_Data)
    
    adult_modelC4_AICc = ModelC4_AICc(adult_modelC4_params,19,1000,Adult_Viral_Data,Adult_CD8_Data)
    aged_modelC4_AICc = ModelC4_AICc(aged_modelC4_params,19,1000,Aged_Viral_Data,Aged_CD8_Data)

    ## GROUP D AICC
    adult_modelD1_AICc = ModelD1_AICc(adult_modelD1_params,19,1000,Adult_Viral_Data,Adult_CD8_Data)
    aged_modelD1_AICc = ModelD1_AICc(aged_modelD1_params,19,1000,Aged_Viral_Data,Aged_CD8_Data)

    adult_modelD2_AICc = ModelD2_AICc(adult_modelD2_params,19,1000,Adult_Viral_Data,Adult_CD8_Data)
    aged_modelD2_AICc = ModelD2_AICc(aged_modelD2_params,19,1000,Aged_Viral_Data,Aged_CD8_Data)

    adult_modelD3_AICc = ModelD3_AICc(adult_modelD3_params,19,1000,Adult_Viral_Data,Adult_CD8_Data)
    aged_modelD3_AICc = ModelD3_AICc(aged_modelD3_params,19,1000,Aged_Viral_Data,Aged_CD8_Data)
    
    adult_modelD4_AICc = ModelD4_AICc(adult_modelD4_params,19,1000,Adult_Viral_Data,Adult_CD8_Data)
    aged_modelD4_AICc = ModelD4_AICc(aged_modelD4_params,19,1000,Aged_Viral_Data,Aged_CD8_Data)
