...
def model2(y,t,p,k_V,c_V,s_T,r,k_T,c_T,d_T):
    V,T = y
...
def Model2_RMSLE(x,times,step_res,Viral_Data,CD8_Data,
    ...
    predictions = sp.integrate.odeint(model2,
                                         y0,
                                         t,
...
def Model2_AICc(x,times,step_res,Viral_Data,CD8_Data,
                 Viral_Data_Col='Viral Titer (Pfu/ml)',
...
def Model2_Predict(x,times,step_res):
