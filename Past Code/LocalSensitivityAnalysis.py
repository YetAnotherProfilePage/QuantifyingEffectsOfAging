...
if __name__ == "__main__":
    ...
    #Run_OAT_SA("MC1","adult",model_estimates["MC1_adult"],{'Viral Clearance Time':Models_ViralClearanceTime_Dict,'Total Viral Load':Models_TotalViralLoad_Dict,'Excess CTL':Models_ExcessCTL_Dict},SAMPLE_SIZE=SAMPLES)
    for model in Models:
        print(f"{model}, adult")
        start = time.time()
