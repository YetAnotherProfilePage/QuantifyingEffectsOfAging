...
def modelA3(y,t,p,k_V,c_V,s_T,r,d_T):
    V,T = y
    
    dVdt = p*V*(1-V/k_V)-c_V*V*T
    dTdt = s_T + r*T*V - d_T*T
...
def ModelA3_RMSLE(x,times,step_res,Viral_Data,CD8_Data,
    ...
    p,k_V,c_V,r,c_T,T_0,V_0 = x #This is the order the parameters should be input.
    ...
    predictions = sp.integrate.odeint(modelA3,
                                         y0,
                                         t,
                                         args=(p,k_V,c_V,s_T,r,c_T)
...
def ModelA3_AICc(x,times,step_res,Viral_Data,CD8_Data,
                 Viral_Data_Col='Viral Titer (Pfu/ml)',
...
def ModelA3_Predict(x,times,step_res):
    p,k_V,c_V,r,c_T,T_0,V_0 = x
    s_T = c_T* T_0
    y0 = [V_0,T_0]
...
def ModelA3_ViralClearanceTime(x,times,step_res,threshhold = 10.0):
    p,k_V,c_V,r,c_T,T_0,V_0 = x
    s_T = c_T* T_0
    y0 = [V_0,T_0]
...
def ModelA3_TotalViralLoad(x,times,step_res,threshhold = 10.0):
    p,k_V,c_V,r,c_T,T_0,V_0 = x
    s_T = c_T* T_0
    y0 = [V_0,T_0]
...
def ModelA3_ExcessCTL(x,times,step_res,threshhold = 10.0):
    p,k_V,c_V,r,c_T,T_0,V_0 = x
    s_T = c_T* T_0
    y0 = [V_0,T_0]
