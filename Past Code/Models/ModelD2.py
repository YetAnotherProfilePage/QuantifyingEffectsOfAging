...
def modelD2(y,t,beta,d_I,p,c,s_T,d_T,r,k_T,c_T,K):
    U,I,V,T = y
...
def ModelD2_RMSLE(x,times,step_res,Viral_Data,CD8_Data,
    ...
    beta,d_I,p,c,d_T,r,k_T,c_T,K,U_0,I_0,V_0,T_0 = x #This is the order the parameters should be input.
    ...
    predictions = sp.integrate.odeint(modelD2,
                                         y0,
                                         t,
                                         args=(beta,d_I,p,c,s_T,d_T,r,k_T,c_T,K)
...
def ModelD2_AICc(x,times,step_res,Viral_Data,CD8_Data,
                 Viral_Data_Col='Viral Titer (Pfu/ml)',
...
def ModelD2_Predict(x,times,step_res):
    beta,d_I,p,c,d_T,r,k_T,c_T,K,U_0,I_0,V_0,T_0 = x #This is the order the parameters should be input.
    #We leave all parameters as inputs in order to do sensitivity analysis later.
...
def ModelD2_ViralClearanceTime(x,times,step_res,threshhold = 10.0):
    beta,d_I,p,c,d_T,r,k_T,c_T,K,U_0,I_0,V_0,T_0 = x #This is the order the parameters should be input.
    #We leave all parameters as inputs in order to do sensitivity analysis later.
...
def ModelD2_TotalViralLoad(x,times,step_res,threshhold = 10.0):
    beta,d_I,p,c,d_T,r,k_T,c_T,K,U_0,I_0,V_0,T_0 = x #This is the order the parameters should be input.
    #We leave all parameters as inputs in order to do sensitivity analysis later.
...
def ModelD2_ExcessCTL(x,times,step_res,threshhold = 10.0):
    beta,d_I,p,c,d_T,r,k_T,c_T,K,U_0,I_0,V_0,T_0 = x #This is the order the parameters should be input.
    #We leave all parameters as inputs in order to do sensitivity analysis later.
