...
def modelB1(y,t,beta,d_I,p,c,s_T,d_T,r,k_T):
    U,I,V,T = y
...
def ModelB1_RMSLE(x,times,step_res,Viral_Data,CD8_Data,
    ...
    predictions = sp.integrate.odeint(modelB1,
                                         y0,
                                         t,
...
def ModelB1_AICc(x,times,step_res,Viral_Data,CD8_Data,
                 Viral_Data_Col='Viral Titer (Pfu/ml)',
...
def ModelB1_Predict(x,times,step_res):
    beta,d_I,p,c,d_T,r,k_T,U_0,I_0,V_0,T_0 = x #This is the order the parameters should be input.
    #We leave all parameters as inputs in order to do sensitivity analysis later.
...
def ModelB1_ViralClearanceTime(x,times,step_res,threshhold = 10.0):
    beta,d_I,p,c,d_T,r,k_T,U_0,I_0,V_0,T_0 = x #This is the order the parameters should be input.
    #We leave all parameters as inputs in order to do sensitivity analysis later.
...
def ModelB1_TotalViralLoad(x,times,step_res,threshhold = 10.0):
    beta,d_I,p,c,d_T,r,k_T,U_0,I_0,V_0,T_0 = x #This is the order the parameters should be input.
    #We leave all parameters as inputs in order to do sensitivity analysis later.
...
def ModelB1_ExcessCTL(x,times,step_res,threshhold = 10.0):
    beta,d_I,p,c,d_T,r,k_T,U_0,I_0,V_0,T_0 = x #This is the order the parameters should be input.
    #We leave all parameters as inputs in order to do sensitivity analysis later.
